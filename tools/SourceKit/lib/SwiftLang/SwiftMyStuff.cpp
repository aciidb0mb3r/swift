...
void doStuff(CompilerInvocation Invocation);
...
void SwiftLangSupport::doMyStuff() { 
...
void doStuff(CompilerInvocation Invocation) {
  ...
  InputBuf = llvm::MemoryBuffer::getMemBuffer("func hello(){}", "<input>");
